      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          className={classNames(
            "fadeIn fixed left-1/2 top-1/2 min-w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-10 text-left shadow-xl focus-visible:outline-none sm:w-full sm:align-middle",
            props.size == "xl"
              ? "sm:max-w-[90rem]"
              : props.size == "lg"
              ? "sm:max-w-[70rem]"
